...
int main()
{
   cout << "--------------------------------------------------------" << endl
    ...
    future<void> hebra_productora = async(launch::async, funcion_hebra_productora);
    future<void> hebra_consumidora = async(launch::async, funcion_hebra_consumidora);
    
    hebra_productora.get();
    hebra_consumidora.get();
    test_contadores();
//   return 0;
}
