...
const int
   ...
   num_items             = 20,
   tam_vector            = 10;
const int tag_prod = 0, tag_cons = 1;
...
{
   for ( unsigned int i= 0 ; i < num_items/4; i++ ){
      // producir valor
...
void funcion_consumidor()
{
   ...
   for( unsigned int i=0 ; i < num_items/5; i++ ){
...
int main( int argc, char *argv[] )
{
   ...
   MPI_Init( &argc, &argv );
   //com. universsal al que pertenecen todos los procesos que se lanzan
